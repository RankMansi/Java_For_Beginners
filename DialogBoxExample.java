...
public class DialogBoxExample {
    public static void main(String[] args) {
        ...
        // Setting layout and adding buttons to the frame
        ...
        showInputDialogButton.addActionListener(e -> {
            String input = JOptionPane.showInputDialog(frame, "Enter something:", "Input Dialog",
                    JOptionPane.QUESTION_MESSAGE);
            if (input != null) {
                JOptionPane.showMessageDialog(frame, "You entered: " + input, "Message",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        });

        showConfirmDialogButton.addActionListener(e -> {
            int option = JOptionPane.showConfirmDialog(frame, "Do you want to continue?", "Confirm Dialog",
                    JOptionPane.YES_NO_OPTION);
            if (option == JOptionPane.YES_OPTION) {
                JOptionPane.showMessageDialog(frame, "You chose to continue.", "Message",
                        JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(frame, "You chose to cancel.", "Message",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        });
